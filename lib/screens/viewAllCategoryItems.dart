...
import '../widgets/itemLongViewWidget.dart';

class ViewAllCategoryItems extends StatefulWidget {
  const ViewAllCategoryItems({Key? key}) : super(key: key);

  @override
  State<ViewAllCategoryItems> createState() => _ViewAllCategoriesState();
}

class _ViewAllCategoriesState extends State<ViewAllCategoryItems> {
  bool hasMore = true;
